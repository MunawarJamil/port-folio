        ...
        <div className="  lg:flex gap-8 w-[90%] items-center  mx-auto  ">
          <div className=" flex flex-col border border-blue-900   my-5 md:text-lg w-full ">
            ...
            <p className="px-2   text-base ">
              ...
              simulation of three.js
            </p>
            <div className="flex justify-between px-5 md:px-9 lg:px-3 my-4">
              <div className="flex gap-1 md:gap-5 lg:gap-1">
                <img src="./Frame.png" alt="" className="w-6 h-6" />
                <img src="./Frame.png" alt="" className="w-6 h-6" />
                <img src="./Frame.png" alt="" className="w-6 h-6" />
                <img src="./Frame.png" alt="" className="w-6 h-6" />
              </div>

              <button>Click Live Site </button>
            </div>
          </div>
